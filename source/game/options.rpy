...
define config.name = _("Masteria Land")
...
define build.name = "MasteriaLand"
...
define config.save_directory = "MasteriaLand-1757488785"
...
init python:
    ...
    build.destination = "E:\Programming-Environment\VisualNovel.Dist\{directory_name}-dists"

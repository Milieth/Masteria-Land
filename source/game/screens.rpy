...
## CTC screen ##################################################################
## Automaticaly Displayed when dialogue has finished showing

transform bouncing_ball:
    easein 0.6 yoffset -25
...
screen ctc(arg=None):
    ...
    hbox:
        ...
        add arg
        add "green ball.png" at bouncing_ball
...
transform setColor:
    matrixcolor TintMatrix("#22e5ff")

define textbox = At("gui/textbox.png", setColor)
...
style window:
    ...
    background Frame(textbox, 32, 32, 32, 32)
...
style navigation_button:
    xsize gui.navigation_button_xsize
    ysize gui.navigation_button_ysize
    hover_background Frame("gui/button/navigation_hover_background.png", gui.navigation_button_hover_background_border)
        ...
        fixed:
            ...
            vbox:
                ...
                hbox:
                    ...
                    textbutton _(">") action FilePageNext(9)
                    key "save_page_next" action FilePageNext(9)
...
#begin language_picker
                ...
                vbox:
                    ...
                    textbutton "Indonesia" text_font "DejaVuSans.ttf" action Language("Indonesia")
